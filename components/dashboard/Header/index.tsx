      ...
      <div className="flex flex-grow items-center justify-between px-4 py-5 shadow-2 md:px-5 2xl:px-10">
        <div className="flex items-center gap-2 sm:gap-4 lg:hidden">
          ...
          <button
            ...
            className="z-99999 block rounded-sm border border-stroke bg-white p-1.5 shadow-sm dark:border-dark-3 dark:bg-dark-2 hover:bg-transparent lg:hidden"
          >
          ...
          <Link className="logo-icn block flex-shrink-0 lg:hidden" href="/dashboard">
            <Image
              width={32}
              height={32}
              src={"/images/icon.png"}
